...
import type { DiscoverySession, GenerationConstraints } from '../types/domain.ts'

export interface UlamPageProps {
  session: DiscoverySession
  onUpdateIngredients: (value: string) => void
  onUpdateConstraints: (patch: Partial<GenerationConstraints>) => void
  onGenerate: () => void
  onRemove: (id: string) => void
}

export function UlamPage({ session, onUpdateIngredients, onUpdateConstraints, onGenerate, onRemove }: UlamPageProps) {
  return (
