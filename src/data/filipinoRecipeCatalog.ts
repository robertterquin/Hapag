...
const rawFilipinoRecipeCatalog = [
  ...
  dish('ginataang-hipon', 'Ginataang Hipon', 'stew', ['shrimp', 'coconut milk', 'garlic', 'chili'], 'simmer', 'Shrimp simmered in creamy coconut milk with aromatics.', ['squash', 'long beans', 'ginger'], [substitute('shrimp', 'fish', 'Firm fish works well in coconut sauce.')]),
  dish('halabos-na-hipon', 'Halabos na Hipon', 'quick meal', ['shrimp', 'garlic', 'oil'], 'steam and sauté', 'Shrimp cooked simply with garlic and a little liquid.', ['chili', 'calamansi', 'butter'], [substitute('shrimp', 'crab', 'Crab can be cooked with the same simple aromatics.')]),
  dish('camaron-rebosado', 'Camaron Rebosado', 'fried', ['shrimp', 'flour', 'egg', 'oil'], 'batter and fry', 'Battered and fried shrimp served with a dipping sauce.', ['cornstarch', 'lemon', 'garlic'], [substitute('shrimp', 'fish', 'Firm fish pieces can use the same batter.')]),
  ...
  dish('adobong-pusit', 'Adobong Pusit', 'simmered', ['squid', 'garlic', 'soy sauce', 'vinegar'], 'simmer', 'Squid cooked quickly in a dark soy-vinegar adobo sauce.', ['onion', 'chili', 'tomato'], [substitute('squid', 'shrimp', 'Shrimp makes a faster seafood adobo.')]),
  dish('ginataang-pusit', 'Ginataang Pusit', 'stew', ['squid', 'coconut milk', 'garlic', 'chili'], 'simmer', 'Squid simmered in spicy coconut milk.', ['ginger', 'onion', 'tomato'], [substitute('squid', 'shrimp', 'Shrimp is a practical coconut-seafood substitute.')]),
  ...
  dish('inihaw-na-pusit', 'Inihaw na Pusit', 'grilled', ['squid', 'soy sauce', 'calamansi', 'garlic'], 'marinate and grill', 'Grilled squid with a bright soy-calamansi marinade.', ['onion', 'chili', 'oil'], [substitute('squid', 'shrimp', 'Shrimp can be grilled with the same marinade.')]),
  dish('tinolang-tahong', 'Tinolang Tahong', 'soup', ['mussels', 'ginger', 'garlic', 'water spinach'], 'boil and simmer', 'Mussels in a light ginger broth with leafy greens.', ['green papaya', 'chili leaves', 'onion'], [substitute('mussels', 'shrimp', 'Shrimp makes a similar aromatic seafood soup.')]),
  dish('ginataang-tahong', 'Ginataang Tahong', 'stew', ['mussels', 'coconut milk', 'garlic', 'chili'], 'simmer', 'Mussels simmered in spicy coconut milk.', ['ginger', 'onion', 'squash'], [substitute('mussels', 'shrimp', 'Shrimp works well in coconut milk.')]),
  dish('adobong-tahong', 'Adobong Tahong', 'simmered', ['mussels', 'garlic', 'soy sauce', 'vinegar'], 'simmer', 'Mussels cooked in a quick soy-vinegar adobo sauce.', ['chili', 'onion', 'ginger'], [substitute('mussels', 'squid', 'Squid makes another quick seafood adobo.')]),
  dish('sinuglaw', 'Sinuglaw', 'seafood', ['fish', 'pork belly', 'vinegar', 'calamansi'], 'grill and toss', 'Grilled pork and citrus-cured fish combined in a Filipino seafood dish.', ['onion', 'chili', 'ginger'], [substitute('fish', 'shrimp', 'Shrimp makes a different but bright seafood version.')]),
  ...
  dish('fish-kilawin', 'Kilawing Isda', 'seafood', ['fish', 'vinegar', 'calamansi', 'onion'], 'cure and toss', 'Fresh fish cured in vinegar and citrus with aromatics.', ['chili', 'ginger', 'coconut milk'], [substitute('fish', 'shrimp', 'Shrimp can be cured with the same citrus dressing.')]),
